...
func discoveryHintLine() string {
	return "Hint: Use `docket search \"query\"` for ticket discovery, `docket start --format json` for workflow guidance, and `docket capabilities --format json` for capability discovery."
}
