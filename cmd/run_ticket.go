...
func init() {
	...
	_ = runTicketCmd.Flags().MarkHidden("review")
	_ = runTicketCmd.Flags().MarkHidden("no-review")
	_ = runNextCmd.Flags().MarkHidden("review")
	_ = runNextCmd.Flags().MarkHidden("no-review")
	...
	_ = runResumeCmd.Flags().MarkHidden("review")
	_ = runResumeCmd.Flags().MarkHidden("no-review")
